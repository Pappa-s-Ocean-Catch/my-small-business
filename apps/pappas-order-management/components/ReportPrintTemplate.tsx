...
const styles = StyleSheet.create({
  ...
  storeName: { color: '#000', fontSize: 30, fontWeight: '800', textAlign: 'center' },
  title: { color: '#000', fontSize: 26, fontWeight: '800', textAlign: 'center', marginTop: 8 },
  period: { color: '#000', fontSize: 19, fontWeight: '700', textAlign: 'center', marginTop: 10 },
  generatedAt: { color: '#333', fontSize: 16, textAlign: 'center', marginTop: 5 },
  divider: { borderTopWidth: 1, borderTopColor: '#000', borderStyle: 'dashed', marginVertical: 15 },
  section: { gap: 8 },
  sectionTitle: { color: '#000', fontSize: 21, fontWeight: '800', textTransform: 'uppercase', marginBottom: 2 },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start', gap: 16 },
  rowLabelWrap: { flex: 1 },
  rowLabel: { color: '#000', fontSize: 19, fontWeight: '600' },
  rowDetail: { color: '#333', fontSize: 16, marginTop: 1 },
  rowValue: { color: '#000', fontSize: 19, fontWeight: '800', textAlign: 'right' },
  financialBlock: { borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#777', gap: 6, paddingTop: 10, marginTop: 3 },
  financialHeading: { color: '#000', fontSize: 19, fontWeight: '800' },
  emptyText: { color: '#333', fontSize: 18 },
  footer: { color: '#333', fontSize: 16, textAlign: 'center' },
});
