                  ...
                  <Link href="/staff" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 text-blue-600 dark:text-blue-400">
                        <Icon icon={FaUsers} className="w-5 h-5" />
                      </div>
                      <div>
            ...
            <div className="pl-2">
              ...
              <div className="pl-2 mt-2">
                ...
                <div className="pl-2 space-y-1">
                  ...
                  <Link className={getLinkClasses("/announcements")} href="/announcements" aria-label="Announcements">Announcements</Link>
                  ...
                  <Link className={getLinkClasses("/marketing")} href="/marketing" aria-label="Auto Marketing">Auto Marketing</Link>
                      ...
                      <Link href="/shop" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                        <div className="flex items-start gap-3">
                          <div className="mt-0.5 text-emerald-600 dark:text-emerald-400">
                            <Icon icon={FaStore} className="w-5 h-5" />
                          </div>
                          <div>
                    ...
                    <div className="mb-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Link href="/shop/inventory" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                            <div className="mt-0.5 text-orange-600 dark:text-orange-400">
                              <Icon icon={FaWarehouse} className="w-4 h-4" />
                            </div>
                            <div>
                  ...
                  <div className="w-1/4 px-3">
                    <div className="mb-2">
                      ...
                      <div className="space-y-2">
                        ...
                        <Link href="/announcements" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                            <div className="mt-0.5 text-purple-600 dark:text-purple-400">
                        ...
                        <Link href="/shop/promotions" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                            <div className="mt-0.5 text-yellow-600 dark:text-yellow-400">
                              <Icon icon={FaMoneyBillWave} className="w-4 h-4" />
                            </div>
                            <div>
                        ...
                        <Link href="/marketing" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                        ...
                        <Link href="/shop/addons" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                            <div className="mt-0.5 text-blue-600 dark:text-blue-400">
                              <Icon icon={FaTag} className="w-4 h-4" />
                            </div>
                            <div>
                              <div className="font-medium text-gray-900 dark:text-white">Add-ons</div>
                              <div className="text-xs text-gray-600 dark:text-gray-400">Manage add-on groups and items</div>
                            </div>
                          </div>
                        </Link>
                        ...
                        <Link href="/shop/google-business-sync" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                          <div className="flex items-start gap-3">
                            <div className="mt-0.5 text-blue-600 dark:text-blue-400">
                              <Icon icon={FaGoogle} className="w-4 h-4" />
                            </div>
                            <div>
      ...
      {userRole === 'admin' && (
        orientation === 'vertical' ? (
          <div className="w-full">
            ...
            <div className="pl-2">
              <Link className={getLinkClasses("/pos-orders")} href="/pos-orders" aria-label="POS orders (TryPosHub)">POS orders</Link>
            ...
            {isReportOpen && (
              <div className="absolute top-full mt-0.5 w-screen max-w-[640px] sm:w-[640px] rounded-xl bg-white/95 dark:bg-neutral-950/95 backdrop-blur shadow-lg z-50 p-3 overflow-hidden"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-2">
                  <Link href="/pos-orders" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                    <div className="flex items-start gap-3">
                      <div className="mt-0.5 text-emerald-600 dark:text-emerald-400">
        ...
        orientation === 'vertical' ? (
          <div className="w-full">
            ...
            <div className="pl-2">
              ...
              <Link className={getLinkClasses("/qr")} href="/qr" aria-label="QR Generator">QR Generator</Link>
            ...
            {isSystemOpen && (
              <div className="absolute top-full mt-0.5 w-screen max-w-[640px] sm:w-[640px] rounded-xl bg-white/95 dark:bg-neutral-950/95 backdrop-blur shadow-lg z-50 p-3 overflow-hidden"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2">
                  ...
                  <Link href="/qr" className="group p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-neutral-900 transition-colors">
                    <div className="flex items-start gap-3">
