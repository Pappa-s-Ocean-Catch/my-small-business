            ...
            <div className="h-full flex flex-col bg-neutral-900">
              ...
              <div className="bg-blue-600 px-4 py-4 flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={closeMenu}
                >
                  <Icon icon={FaTimes} className="w-5 h-5 text-white" />
                </button>
              </div>
                ...
                {!mounted ? (
                  ...
                  <div className="space-y-2 bg-neutral-800">
                    ...
                    <div className="border-b border-neutral-700 pb-2 bg-neutral-800">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Icon icon={FaUsers} className="w-5 h-5 text-blue-400" />
                          <span className="font-semibold text-white">Management</span>
                        </div>
                        <Icon icon={FaChevronDown} className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${mgmtOpen ? 'rotate-180' : ''}`} />
                      </button>
                      {mgmtOpen && (
                    ...
                    <div className="border-b border-neutral-700 pb-2 bg-neutral-800">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Icon icon={FaStore} className="w-5 h-5 text-green-400" />
                          <span className="font-semibold text-white">Shop</span>
                        </div>
                        <Icon icon={FaChevronDown} className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${shopOpen ? 'rotate-180' : ''}`} />
                      </button>
                      {shopOpen && (
                        <div className="ml-8 mt-2 space-y-1">
                          ...
                          <Link href="/orders" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                            <Icon icon={FaShoppingBag} className="w-4 h-4 mr-2 text-blue-400" />
                            Orders
                          </Link>
                          <Link href="/announcements" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                          ...
                          <Link href="/shop/categories" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                            <Icon icon={FaTags} className="w-4 h-4 mr-2 text-purple-400" />
                            Categories
                          </Link>
                          <Link href="/shop/inventory" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                            <Icon icon={FaWarehouse} className="w-4 h-4 mr-2 text-orange-400" />
                            Inventory
                          </Link>
                          <Link href="/shop/suppliers" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
                            <Icon icon={FaShoppingBag} className="w-4 h-4 mr-2 text-yellow-400" />
                            Suppliers
                          </Link>
                    ...
                    <div className="border-b border-neutral-700 pb-2 bg-neutral-800">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Icon icon={FaChartPie} className="w-5 h-5 text-purple-400" />
                          <span className="font-semibold text-white">Analysis & Reports</span>
                        </div>
                        <Icon icon={FaChevronDown} className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${reportsOpen ? 'rotate-180' : ''}`} />
                      </button>
                      {reportsOpen && (
                        <div className="ml-8 mt-2 space-y-1">
                    ...
                    <div className="pb-2 bg-neutral-800">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          <Icon icon={FaCog} className="w-5 h-5 text-gray-400" />
                          <span className="font-semibold text-white">System</span>
                        </div>
                        <Icon icon={FaChevronDown} className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${systemOpen ? 'rotate-180' : ''}`} />
                      </button>
                      {systemOpen && (
                        <div className="ml-8 mt-2 space-y-1">
                          ...
                          <Link href="/webhooks" onClick={closeMenu} className="flex items-center px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/10 rounded-lg transition-colors">
              ...
              <div className="border-t border-neutral-700 p-4 bg-neutral-800/50">
                <div className="flex items-center gap-3 p-3 bg-red-500/20 border border-red-500/30 rounded-lg">
                  <Icon icon={FaExclamationTriangle} className="w-4 h-4 text-red-400" />
