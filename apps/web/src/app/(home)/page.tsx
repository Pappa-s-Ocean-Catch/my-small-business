...
export default function Home() {
  ...
  useEffect(() => {
    const fetchFeaturedProducts = async () => {
      try {
        ...
        // Fetch some active products with images for featured section
  ...
  const structuredData = {
    ...
    "image": `${process.env.NEXT_PUBLIC_SITE_URL || "https://pappasfishnchips.com.au"}/og-image.png`,
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            <h1 className="hidden text-5xl md:text-7xl font-bold text-white mb-6 drop-shadow-lg">
