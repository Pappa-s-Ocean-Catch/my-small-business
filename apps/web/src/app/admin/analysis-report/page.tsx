    ...
    <AdminGuard>
      <div className="p-3 sm:p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Link href="/admin/reports/shift-reports" className="block rounded-xl border p-4 bg-white dark:bg-neutral-900 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">
          ...
          <Link href="/admin/analytics" className="block rounded-xl border p-4 bg-white dark:bg-neutral-900 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">
          ...
          <Link href="/admin/wages-report" className="block rounded-xl border p-4 bg-white dark:bg-neutral-900 hover:bg-gray-50 dark:hover:bg-neutral-800 transition">
